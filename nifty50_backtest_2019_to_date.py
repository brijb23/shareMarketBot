...
class BacktestLogger:
    def __init__(self, name):
        ...
        self.log_file = Config.LOG_DIR / f'BACKTEST_2019_{self.timestamp}.txt'
        self.messages = []
...
logger = BacktestLogger('BACKTEST_2019')
...
class BacktestRunner:
    ...
    def run(self):
        ...
        try:
            self.logger.log("\n" + "="*70)
            self.logger.log("NIFTY50 BACKTEST 2019 TO DATE - STARTING")
            self.logger.log("="*70)
            self.logger.log(f"Initial Capital: {Config.INITIAL_CAPITAL:,} INR")
            
            # Step 1: Download data (2019 to date)
    ...
    def generate_outputs(self):
        ...
        # CSV output
        csv_file = Config.OUTPUT_DIR / f'BACKTEST_WEEKLY_2019_{timestamp}.csv'
        if self.portfolio.monthly_results:
        ...
        # Trades CSV
        trades_file = Config.OUTPUT_DIR / f'BACKTEST_TRADES_2019_{timestamp}.csv'
        ...
        # JSON output
        json_file = Config.OUTPUT_DIR / f'BACKTEST_RESULTS_2019_{timestamp}.json'
        output = {
            'metadata': {
                'generated': timestamp,
        ...
        # Summary text
        summary_file = Config.OUTPUT_DIR / f'BACKTEST_SUMMARY_2019_{timestamp}.txt'
        with open(summary_file, 'w') as f:
            f.write("NIFTY50 BACKTEST SUMMARY (WEEKLY) - 2019 TO DATE\n")
            f.write("="*60 + "\n\n")
